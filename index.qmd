...
- Despite the statement above, **I have been able to sign-in with a password** using the Google Browser.
...
- [ ] If you see a message like the one in this screenshot, **for any packages**, click install.\
